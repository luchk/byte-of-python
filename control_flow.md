...
Remember that the `else` part is optional. When included, it is always executed once after the `for` loop is over unless a [break](control_flow.md#break-statement) statement is encountered.
